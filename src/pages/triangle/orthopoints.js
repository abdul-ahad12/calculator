...
const Orthopoints = () => {
  ...
  const resultDumm = () => {
    const result = triangle.orthopoints(
      coeficient.a,
      coeficient.b,
      coeficient.c,
      coeficient.d,
  ...
  return (
    <div>
      <Helmet>
        <title>Orthocentre of a triangle from Vertices.</title>
        <meta
          name="description"
          content="Free calculator to find Orthocentre of a triangle from Vertices."
        />
      </Helmet>
      <TitleTemplate

    ...
    <div>
      <MainLayout>
        <div className='className="w-full flex mx-10 flex-col items-center justify-center h-[100%] '>
          ...
          <div className="  ">
            We do not collect data that our users enter into our Calculators. We
            neither store nor sell the data that you enter in our calculators.
          </div>
          ...
          <div className="  ">
            By using this Site, you confirm and acknowledge your acceptance of

...
const ResultTemp = ({ a, b, c, d, e, f, g, h, i, j, k }) => {
  return (
    <div  className="border base:text-[15px] max-w-[1800px] md:text-[25px] lg:text-[30px] lg:p-5 base:p-2 border-black flex flex-col">
      <div className="text-start" >
        ...
        <div className="result">Length of Major axis</div>
        <div className="result">{a}</div>
        </div>
        <div className="flex flex-row">

        <div className="result">Length of Minor axis</div>
        ...
        <div className="result">Equation of Major axis</div>
        <div className="result">{i}</div>
        </div>

        <div className="flex flex-row">

        <div className="result">Equation of Minor axis</div>
